...
async def create_superuser(full_name: str, email: str, password: str) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--name",     default=None, dest="full_name")
    args = parser.parse_args()

    full_name = args.full_name or prompt("Имя")
    ...
    asyncio.run(create_superuser(full_name, email, password))
