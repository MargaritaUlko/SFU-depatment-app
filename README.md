...
| GET | /schedule/group/{id} | Расписание группы | авторизован |
| GET | /schedule/teacher?name=... | Расписание препода | авторизован |
| POST | /schedule/cache/clear | Сброс кеша | admin |
...
```
app/
├── core/         # config, security, cache (TTLCache)
├── db/           # engine, session, Base
├── models/       # SQLAlchemy ORM модели
├── schemas/      # Pydantic схемы
├── crud/         # Операции с БД
├── services/     # JWT, парсер расписания, хранение файлов
